...
Block.defineBlock(221, "Magica Orbis Expender", [
    ["quartz_block", 5]
]);
...
Block.defineBlock(222, "Sparkling Dust", [
...
Block.defineBlock(223, "Push Stone Plus", [
    ["quartz_block", 0]
], 1, false, 11);
...
if (Magica.read("lang", true) == "true") {
    Block.defineBlock(200, "초록색 반짝이는 돌", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(201, "보라색 반짝이는 돌", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(202, "반짝이는 나무 목재", [
        ["planks", 0]
    ]);
    Block.defineBlock(203, "반짝이는 나무 반 블록", [
        ["planks", 0]
    ], 1, false, 0);
    Block.defineBlock(204, "반짝이는 나무", [
        ["log", 1],
        ["log", 1],
        ["log", 0],
        ["log", 0],
    ...
    Block.defineBlock(205, "반짝이는 나뭇잎", [
        ["leaves", 0]
    ], 1, false, 0);
    Block.defineBlock(206, "청록색 블록", [
        ["quartz_block", 1]
    ]);
    Block.defineBlock(207, "노란색 블록", [
        ["quartz_block", 0]
    ]);
    Block.defineBlock(208, "하늘 블록", [
        ["quartz_block", 0]
    ]);
    Block.defineBlock(209, "불타는 블록", [
        ["flowing_lava", 0]
    ]);
    Block.defineBlock(210, "Magica Orbis 포탈", [
        ["still_water", 0]
    ], 1, false, 0);
    Block.defineBlock(211, "반짝이는 울타리", [
        ["planks", 0]
    ], 1, false, 11);
    Block.defineBlock(212, "밀치는 돌", [
        ["quartz_block", 0]
    ]);
    Block.defineBlock(213, "마법적인 노란색 블록", [
        ["quartz_block", 5]
    ]);
    Block.defineBlock(214, "마법 랜턴(켜짐)", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(215, "마법 랜턴(꺼짐)", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(216, "붉은색 반짝이는 돌", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(217, "아이템 지급기", [
        ["quartz_block", 1]
    ]);
    Block.defineBlock(218, "압력 수신기", [
        ["quartz_block", 4]
    ]);
    Block.defineBlock(219, "링크 포탈", [
        ["stonebrick", 3]
    ]);
    Block.defineBlock(220, "링크 포탈 (비활성화)", [
        ["stonebrick", 3]
    ]);
    ...
    Block.defineBlock(200, "Green Sparkling Stone", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(201, "Purple Sparkling Stone", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(202, "Sparkling Planks", [
        ["planks", 0]
    ]);
    Block.defineBlock(203, "Half Sparkling Planks", [
        ["planks", 0]
    ], 1, false, 0);
    Block.defineBlock(204, "Sparkling Log", [
        ["log", 1],
        ["log", 1],
        ["log", 0],
        ["log", 0],
    ...
    Block.defineBlock(205, "Sparkling Leaf", [
        ["leaves", 0]
    ], 1, false, 0);
    Block.defineBlock(206, "Cyan Block", [
        ["quartz_block", 1]
    ]);
    Block.defineBlock(207, "Yellow Block", [
        ["quartz_block", 0]
    ]);
    Block.defineBlock(208, "Sky Block", [
        ["quartz_block", 0]
    ]);
    Block.defineBlock(209, "Burning Block", [
        ["flowing_lava", 0]
    ]);
    Block.defineBlock(210, "Portal to Magica Orbis", [
        ["still_water", 0]
    ], 1, false, 0);
    Block.defineBlock(211, "Sparkling Fence", [
        ["planks", 0]
    ], 1, false, 11);
    Block.defineBlock(212, "Push Stone", [
        ["quartz_block", 0]
    ]);
    Block.defineBlock(213, "Magical Yellow Stone", [
        ["quartz_block", 5]
    ]);
    Block.defineBlock(214, "Magic Lantern(on)", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(215, "Magic Lantern(off)", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(216, "Red Sparkling Stone", [
        ["end_stone", 0]
    ]);
    Block.defineBlock(217, "Item Giver", [
        ["quartz_block", 1]
    ]);
    Block.defineBlock(218, "Decompression Receiver", [
        ["quartz_block", 4]
    ]);
    Block.defineBlock(219, "Link Portal", [
        ["stonebrick", 3]
    ]);
    Block.defineBlock(220, "Link Portal off", [
        ["stonebrick", 3]
    ]);
...
function useItem(x, y, z, i, b, s, it, bd) {
    ...
    if (b == 220) {
        ...
        if (Level.getSignText(x, y + 1, z, 1) == "Return") {
            ...
            Entity.setPosition(Player.getEntity(), 17.5, 11.5, 123.5);
            Level.spawnWaterSlime(28, 8.5, 121);
            Level.spawnWaterSlime(23, 8.5, 117);
